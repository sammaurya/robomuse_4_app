...
import com.sammaurya.robomuse.Core.Plans.RandomWalkPlan;
import com.sammaurya.robomuse.Core.Plans.RobotPlan;
import com.sammaurya.robomuse.Core.Plans.SimpleWaypointPlan;
import com.sammaurya.robomuse.Core.Plans.WaypointPlan;
...
public enum ControlMode {
     ...
     */
    public static RobotPlan getRobotPlan(Context context, ControlMode controlMode) {

        RobotPlan plan;

        switch (controlMode) {

            case SimpleWaypoint: plan = new SimpleWaypointPlan(context); break;
            case Waypoint: plan = new WaypointPlan(context); break;
