 ...
 */
public class RobotInfoAdapter extends Adapter<RobotInfoAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View v) {
            ...
            mRobotNameTextView = v.findViewById(R.id.robot_name_text_view);
            mMasterUriTextView = v.findViewById(R.id.master_uri_text_view);

            mEditButton = v.findViewById(R.id.robot_edit_button);
            mEditButton.setOnClickListener(this);

            mDeleteButton = v.findViewById(R.id.robot_delete_button);
            mDeleteButton.setOnClickListener(this);

            mWifiImage = v.findViewById(R.id.robot_wifi_image);
            mWifiImage.setImageResource(R.drawable.wifi_0);
            ...
            t.scheduleAtFixedRate(new TimerTask() {
                ...
                public void run() {
                    try {
                        ...
                        //mWifiImage.setLayoutParams(new ActionBar.LayoutParams(mEditButton.getHeight(), mEditButton.getHeight()));
                        ...
                        if (isPortOpen(info.getUri().getHost(), info.getUri().getPort(), 10000)) {
                            activity.runOnUiThread(new Runnable() {
                                ...
                                @Override
                                public void run() {
                                    mWifiImage.setImageResource(R.drawable.wifi_4);
                                }
                            });
                        } else {
                            activity.runOnUiThread(new Runnable() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.robot_edit_button:
                    ...
                    editRobotDialogFragment.show(activity.getSupportFragmentManager(), "editrobotdialog");
                    break;
