...
//                Log.d(TAG, "name = " + info.getName().substring(5));
    ...
    public void load(@NonNull Bundle bundle) {
        ...
        cameraTopic = bundle.getString(CAMERA_TOPIC_KEY, "/image_color/compressed");
    ...
    public void load(@NonNull SharedPreferences prefs) {
        ...
        cameraTopic = prefs.getString(RobotStorage.getPreferenceKey(CAMERA_TOPIC_KEY), "/image_color/compressed");
