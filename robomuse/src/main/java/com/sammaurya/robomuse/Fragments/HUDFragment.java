...
public class HUDFragment extends SimpleFragment implements MessageListener<Odometry>{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            speedView = view.findViewById(R.id.hud_speed);
            turnrateView = view.findViewById(R.id.hud_turnrate);
//            locationView = (TextView) view.findViewById(R.id.hud_location);
            latView = view.findViewById(R.id.hud_gps_lat);
            longView = view.findViewById(R.id.hud_gps_long);
        ...
        if (emergencyStopButton == null) {
            try {
                ...
                emergencyStopButton = view.findViewById(R.id.emergency_stop_button);
    ...
    public void toggleEmergencyStopUI(boolean stop) {
        ...
        if (((MainActivity)getControlApp()).getControlMode().USER_CONTROLLED)
    ...
    private void initEmergencyStopButton() {
        emergencyStopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!((Teleop)getActivity()).getControlMode().USER_CONTROLLED) {
                    // Try to resume a paused plan first
                    if (((Teleop) getActivity()).getRobotController().resumePlan()) {
                        toggleEmergencyStopUI(true);
                    } else if (((Teleop)getActivity()).stopRobot(true)) {
    ...
    private class UpdateUIRunnable implements Runnable
    {
        ...
        public void run() {
            ...
            try {
                ...
                if (latView != null) {
                    Location location = ((Teleop) getActivity()).getRobotController().
