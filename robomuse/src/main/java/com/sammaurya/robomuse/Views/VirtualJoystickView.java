 ...
 *
 * The VirtualJoystickView has been extended to allow control from a device's accelerometers.
 *
...
public class VirtualJoystickView extends RelativeLayout implements AnimationListener,
    ...
    private final SensorEventListener ACCEL_LISTENER = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event)
        {
            ...
            Display display = ((WindowManager) VirtualJoystickView.this.getContext().getSystemService(
...
//        }
    ...
    private void publishVelocity(double linearVelocityX, double linearVelocityY,
        ...
        ((Teleop) getContext()).getRobotController().
